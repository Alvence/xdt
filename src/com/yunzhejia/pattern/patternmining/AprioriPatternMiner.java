...
public class AprioriPatternMiner implements IPatternMiner {
	Discretizer discretizer = null;
	
	public AprioriPatternMiner(Discretizer discretizer){
...
//		System.out.println(copy);
	...
	public static void main(String[] args) {
		try {
			...
			AprioriPatternMiner miner = new AprioriPatternMiner(discretizer);
