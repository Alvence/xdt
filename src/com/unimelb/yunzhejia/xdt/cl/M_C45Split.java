 ...
 * @version $Revision$
 */
public class M_C45Split extends M_ClassifierSplitModel {
   ...
   */
  public M_C45Split(int attIndex, int minNoObj, double sumOfWeights,
   ...
   */
  public void buildClassifier(Instances trainInstances, Map<Long, Set<Integer>> expls) throws Exception {
    ...
    if (trainInstances.attribute(m_attIndex).isNominal()) {
      ...
      handleEnumeratedAttribute(trainInstances,expls);
    } else {
      m_complexityIndex = 2;
      m_index = 0;
      trainInstances.sort(trainInstances.attribute(m_attIndex));
      handleNumericAttribute(trainInstances,expls);
    }
  }
   ...
   * @exception Exception if something goes wrong
   */
  private void handleEnumeratedAttribute(Instances trainInstances, Map<Long, Set<Integer>> expls)
    throws Exception {

    Instance instance;

    m_distribution = new M_Distribution(m_complexityIndex,
    ...
    while (enu.hasMoreElements()) {
      ...
      if (!instance.isMissing(m_attIndex) && (expls.get(instance.getID())==null || expls.get(instance.getID()).contains(m_attIndex))) {
//      if (!instance.isMissing(m_attIndex)){
   ...
   * @exception Exception if something goes wrong
   */
  private void handleNumericAttribute(Instances trainInstances, Map<Long, Set<Integer>> expls)
    throws Exception {
    ...
    m_distribution = new M_Distribution(2, trainInstances.numClasses());
    ...
    while (enu.hasMoreElements()) {
      instance = enu.nextElement();
//      System.out.println(expls.get(instance.getID())+"  "+m_attIndex);
      if (instance.isMissing(m_attIndex) ||  (expls.get(instance.getID())!=null && !expls.get(instance.getID()).contains(m_attIndex))) {
//      if (instance.isMissing(m_attIndex)){  
//      	System.out.println(expls.get(instance.getID())+"  "+m_attIndex);
    	  break;
  ...
  public void resetDistribution(Instances data) throws Exception {
    ...
    M_Distribution newD = new M_Distribution(insts, this);
