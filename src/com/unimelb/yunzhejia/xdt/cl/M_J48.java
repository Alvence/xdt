 ...
 * @version $Revision$
 */
public class M_J48 extends AbstractClassifier implements OptionHandler, Drawable,
  ...
  /** The decision tree */
  public M_ClassifierTree m_root;
  ...
  public void buildClassifierWithExpl(Instances instances, Map<Long, Set<Integer>> expls) throws Exception {
    ...
    M_ModelSelection modSelection;

   
    modSelection = new M_C45ModelSelection(m_minNumObj, instances,
    		m_useMDLcorrection, m_doNotMakeSplitPointActualValue);
    
    
    m_root = new M_C45PruneableClassifierTree(modSelection, !m_unpruned, m_CF,
    		m_subtreeRaising, !m_noCleanup, m_collapseTree);
    
      
    m_root.buildClassifierWithExpl(instances, expls);
    
    ((M_C45ModelSelection) modSelection).cleanup();
