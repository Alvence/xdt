 ...
 * @version $Revision$
 */
public class M_C45ModelSelection extends M_ModelSelection {
   ...
   */
  public M_C45ModelSelection(int minNoObj, Instances allData,
 ...
 * @throws Exception 
   */
  @Override
  public final M_ClassifierSplitModel selectModel(Instances data) throws Exception {

	  throw new Exception("unimplemented method");
  }
  @Override
  public final M_ClassifierSplitModel selectModelWithExpl(Instances data, Map<Long, Set<Integer>> expls) {

	    double minResult;
	    M_C45Split[] currentModel;
	    M_C45Split bestModel = null;
	    NoSplit noSplitModel = null;
	    double averageInfoGain = 0;
	    int validModels = 0;
	    boolean multiVal = true;
	    M_Distribution checkDistribution;
	    Attribute attribute;
	    double sumOfWeights;
	    int i;
	    ...
	    try {
	      ...
	      checkDistribution = new M_Distribution(data);
	      ...
	      currentModel = new M_C45Split[data.numAttributes()];
	      ...
	      for (i = 0; i < data.numAttributes(); i++) {
	        ...
	        if (i != (data).classIndex()) {
	          ...
	          currentModel[i] = new M_C45Split(i, m_minNoObj, sumOfWeights,
	            m_useMDLcorrection);
	          currentModel[i].buildClassifier(data, expls);
 ...
 * @throws Exception 
   */
  @Override
  public final M_ClassifierSplitModel selectModel(Instances train, Instances test) throws Exception {
