...
public final class GainRatioSplitCrit extends EntropyBasedSplitCrit {
   ...
   */
  @Override
  public final double splitCritValue(M_Distribution bags) {
   ...
   */
  public final double splitCritValue(M_Distribution bags, double totalnoInst,
    double numerator) {
   ...
   */
  private final double splitEnt(M_Distribution bags, double totalnoInst) {
