...
public class M_C45PruneableClassifierTree 
  extends M_ClassifierTree {
   ...
   */
  public M_C45PruneableClassifierTree(M_ModelSelection toSelectLocModel,
  ...
  public void buildClassifierWithExpl(Instances data, Map<Long, Set<Integer>> expls) throws Exception {
	   ...
	   buildTreeWithExpl(data, m_subtreeRaising || !m_cleanup, expls);
  ...
  public void prune() throws Exception {
    ...
    M_C45PruneableClassifierTree largestBranch;
    int i;
  ...
  @Override
  protected M_ClassifierTree getNewTreeWithExpl(Instances data, Map<Long, Set<Integer>> expls) throws Exception {
	    
	    M_C45PruneableClassifierTree newTree = 
	      new M_C45PruneableClassifierTree(m_toSelectModel, m_pruneTheTree, m_CF,
					     m_subtreeRaising, m_cleanup, m_collapseTheTree);
	    newTree.buildTreeWithExpl((Instances)data, m_subtreeRaising || !m_cleanup,expls);
  ...
  private double getEstimatedErrorsForBranch(Instances data) 
    ...
    if (m_isLeaf)
      return getEstimatedErrorsForDistribution(new M_Distribution(data));
    else{
      M_Distribution savedDist = localModel().m_distribution;
   ...
   * @return the estimated errors
   */
  private double getEstimatedErrorsForDistribution(M_Distribution 
						   theDistribution){
  ...
  private M_ClassifierSplitModel localModel(){
    ...
    return (M_ClassifierSplitModel)m_localModel;
  }
   ...
   * Method just exists to make program easier to read.
   */
  private M_C45PruneableClassifierTree son(int index){

    return (M_C45PruneableClassifierTree)m_sons[index];
  }
