...
public final class NoSplit
  extends M_ClassifierSplitModel{
   ...
   */
  public NoSplit(M_Distribution distribution){
    
    m_distribution = new M_Distribution(distribution);
    m_numSubsets = 1;
  }
  ...
  public final void buildClassifier(Instances instances) 
    ...
    m_distribution = new M_Distribution(instances);
    m_numSubsets = 1;
  }
