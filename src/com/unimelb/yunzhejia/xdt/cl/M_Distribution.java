 ...
 * @version $Revision$
 */
public class M_Distribution implements Cloneable, Serializable, RevisionHandler {
   ...
   */
  public M_Distribution(int numBags, int numClasses) {
   ...
   */
  public M_Distribution(double[][] table) {
   ...
   */
  public M_Distribution(Instances source) throws Exception {
  ...
  public M_Distribution(Instances source, M_ClassifierSplitModel modelToUse) throws Exception {
   ...
   * distribution.
   */
  public M_Distribution(M_Distribution toMerge) {
   ...
   * indicated one.
   */
  public M_Distribution(M_Distribution toMerge, int index) {
  ...
  public final Object clone() {
    ...
    M_Distribution newDistribution = new M_Distribution(m_perBag.length,
      m_perClass.length);
    for (i = 0; i < m_perBag.length; i++) {
   ...
   * bag.
   */
  public final M_Distribution subtract(M_Distribution toSubstract) {

    M_Distribution newDist = new M_Distribution(1, m_perClass.length);
