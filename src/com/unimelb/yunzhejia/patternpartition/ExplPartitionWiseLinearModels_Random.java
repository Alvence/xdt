...
public class ExplPartitionWiseLinearModels_Random extends AbstractClassifier {
...
//			Instances test = DataUtils.load("data/"+"synthetic_10samples.arff");
			...
			ExplPartitionWiseLinearModels_Random cl = new ExplPartitionWiseLinearModels_Random();
...
//			cl.buildClassifierWithExpl(train, expls);
	...
	public static double evalExpl(ExplPartitionWiseLinearModels_Random cl, Instances data, Map<Long, Set<Integer>> expls) throws Exception{
		double ret = 0;
