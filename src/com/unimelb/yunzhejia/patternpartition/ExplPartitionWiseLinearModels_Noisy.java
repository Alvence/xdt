...
public class ExplPartitionWiseLinearModels_Noisy extends AbstractClassifier {
...
//			Instances test = DataUtils.load("data/"+"synthetic_10samples.arff");
			...
			ExplPartitionWiseLinearModels_Noisy cl = new ExplPartitionWiseLinearModels_Noisy();
...
//			cl.buildClassifierWithExpl(train, expls);
	...
	public static double evalExpl(ExplPartitionWiseLinearModels_Noisy cl, Instances data, Map<Long, Set<Integer>> expls) throws Exception{
		double ret = 0;
